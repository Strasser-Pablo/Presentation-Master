...
\begin{frame}{Projection}
 ...
 \begin{property}
 Pour chaque vecteur $\vect{v}$ on peut \emph{projeter} dans un espace à \emph{divergence} nulle sans changer le \emph{rotatinonel} en resolvant:
  \begin{align*}
  \vect{v}_{new}&=v-\vect{\nabla} p\\
  \Delta p&=\vect{\nabla} \cdot \vect{v}
  \end{align*}
...
\begin{frame}{Idée}
 \begin{itemize}
  ...
  \item Mais la topology est determiné par la position des particules.
  \item Les particules se déplacent par la vitesse donné par interpolation de la grille.
  \item Les conditions aux bords sont imposé en créant des points fantomes en vitesse et pression
 \end{itemize}
